...
casename="iHIST1700.$resolution.fatesnocomp.$noresmversion.S3_TRENDY2025_pt1_newCPUs.202508018" 
...
then
    ...
    then    
        ...
        ./xmlchange CLM_CO2_TYPE=diagnostic #S1,S2,S3
        ./xmlchange DATM_CO2_TSERIES=20trtrendy25  #S1,S2,S3
        ...
        echo "fluh_timeseries = '/cluster/work/users/kjetisaa/Trendy_2025_forcing/LUH3/Lowres/LUH2_timeseries_to_surfdata_1.9x2.5_250723_cdf5.nc'" >> $workpath$casename/user_nl_clm   #S3                     
