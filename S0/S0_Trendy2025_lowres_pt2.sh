...
casename="iHIST1700.$resolution.fatesnocomp.$noresmversion.S0_TRENDY2025_pt2.202508020"
...
then
    ...
    then    
        ...
        echo "finidat = '/cluster/projects/nn9188k/kjetisaa/Trendy25//iHIST1700.f19_g17.fatesnocomp.ctsm5.3.045_noresm_v10.S0_TRENDY2025_pt1.202508018.clm2.r.1851-01-01-00000.nc' " >> user_nl_clm
    fi
fi
