...
casename="iHIST1700.$resolution.fatesnocomp.$noresmversion.S0_TRENDY2025_pt1.202508018" #TEST
...
then
    ...
    then    
        ...
        ./xmlchange CCSM_CO2_PPMV=277.57 #S0
        ./xmlchange CLM_CO2_TYPE=constant #S0
        ./xmlchange DATM_YR_START=1901
        ./xmlchange DATM_YR_ALIGN=1701
        ...
        echo "fluh_timeseries = '/cluster/work/users/kjetisaa/Trendy_2025_forcing/LUH3/Lowres/LUH2_states_transitions_management.timeseries_1.9x2.5_hist_steadystate_1700_2025-07-23_cdf5.nc'" >> $workpath$casename/user_nl_clm #S0,S1,S2
        ...
        echo "finidat = '/cluster/home/kjetisaa/Trendy_2025_scripts/Restarts/i1700.f19_g17.fatesnocomp.ctsm5.3.045_noresm_v10.PostADspinup_TRENDY2025.20250816.clm2.r.0401-01-01-00000.nc' " >> user_nl_clm
    fi
fi
